                    ...
                    <div class="patient-details">
                        ...
                        <div class="detail-item mb-3">
                            <div class="d-flex justify-content-between">
                                ...
                                <span
                                    class="badge bg-primary">{{ $patient->visits_count ?? $patient->visits()->count() }}</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="card bg-success text-white">
                                <div class="card-body py-2 text-center">
                                    ...
                                    <h4 class="mb-0">{{ $patient->visits()->whereYear('created_at', date('Y'))->count() }}
                                    </h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card bg-info text-white">
                                <div class="card-body py-2 text-center">
                                    ...
                                    <h4 class="mb-0">{{ $patient->visits()->whereMonth('created_at', date('m'))->count() }}
                                    </h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card bg-warning text-white">
                                <div class="card-body py-2 text-center">
                                    ...
                                    <h4 class="mb-0">
                                        {{ $patient->visits()->whereDate('created_at', date('Y-m-d'))->count() }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                @forelse($visits as $visit)
                                    <tr>
                                        ...
                                        <td>
                                            @if($visit->medicalRecord)
                                                <span
                                                    class="badge bg-info">{{ Str::limit($visit->medicalRecord->diagnosa, 20) }}</span>
                                            @else
                                                <span class="text-muted">-</span>
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                ...
                                                @elseif(auth()->user()->role == 'dokter')
                                                    <a href="{{ route('medical-records.create', $visit) }}" class="btn btn-success"
                        ...
                        @foreach($visits as $visit)
                            @if($visit->medicalRecord)
                                <div class="timeline-item mb-4">
                                    <div class="timeline-marker {{ $visit->status == 'selesai' ? 'bg-success' : 'bg-warning' }}">
                                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row g-2">
                        ...
                        <div class="col-md-6">
                            <a href="{{ route('patients.edit', $patient) }}" class="btn btn-warning w-100 h-100 py-3">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea class="form-control" id="quickNote" rows="2"
                            placeholder="Tambahkan catatan untuk pasien ini..."></textarea>
