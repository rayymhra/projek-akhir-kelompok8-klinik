...
@section('styles')
    <style>
        ...
        .medicine-card[data-type="Tablet"]::before {
            background: linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%);
        }

        .medicine-card[data-type="Sirup"]::before {
            background: linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%);
        }

        .medicine-card[data-type="Kapsul"]::before {
            background: linear-gradient(135deg, #10b981 0%, #059669 100%);
        }

        .medicine-card[data-type="Salep"]::before {
            background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%);
        }

        .medicine-card[data-type="Injeksi"]::before {
                    ...
                    <form method="GET" class="row g-2 align-items-center">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="stock" class="form-select form-select-sm" onchange="this.form.submit()">
                                ...
                                <option value="low" {{ request('stock') == 'low' ? 'selected' : '' }}>Stok Rendah (≤10)
                                </option>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="search-container">
                                ...
                                <input type="text" class="form-control form-control-sm search-input" name="search"
                        ...
                        <div class="col-md-2 d-flex align-items-end">
                            <div class="d-flex gap-2 w-100">
                                ...
                                @if(request()->anyFilled(['jenis', 'stock', 'search']))
                                    <a href="{{ route('medicines.index') }}" class="btn btn-outline-danger btn-sm"
                                        type="button">
                        ...
                        <div class="card-body py-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h2 class="mb-0 {{ $lowStockCount > 0 ? 'text-warning' : '' }}">{{ $lowStockCount }}
                                    </h2>
                                    ...
                                    @foreach($medicines as $medicine)
                                        @php
                                            ...
                                            if ($medicine->expired_date) {
                                                ...
                                                // Jika > 30 hari, tidak masuk kondisi else, jadi status 'safe' dan tidak ada teks
                                            }
                                        @endphp
                                        @endphp
                                        <tr>
                                            ...
                                            <td>
                                                @if($medicine->expired_date)
                                                    <div class="d-flex flex-column gap-1">
                                                        <span
                                                            class="text-{{ $expiryStatus == 'expired' ? 'danger' : ($expiryStatus == 'expiring-soon' ? 'warning' : 'success') }}">
                                                        ...
                                                        @else
                                                            <small class="text-muted">
                                                                ...
                                                                {{ $medicine->expired_date->diffForHumans(['parts' => 1]) }}
                                                            </small>
                                                        @endif
                                                    </div>
                                                @else
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-2">
                                                    ...
                                                    <a href="{{ route('medicines.stock-history', $medicine) }}"
                                                        class="quick-action-btn btn btn-sm btn-light" data-bs-toggle="tooltip"
                                                        title="Riwayat Stok">
                                                    ...
                                                    <!-- Delete Trigger -->
                                                    <button type="button" class="quick-action-btn btn btn-sm btn-light"
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="text-center mb-4">
                                                                    <div
                                                                        class="bg-danger bg-opacity-10 p-3 rounded-circle d-inline-block">
                                                                        <i class="fas fa-trash fa-2x text-danger"></i>
                                                                    </div>
                                                                </div>

                                                                <p class="text-center mb-3">Apakah Anda yakin ingin menghapus obat
                                                                    ini?</p>
                                                                ...
                                                                @if($medicine->prescriptions()->count() > 0)
                                                                    <div class="alert alert-danger">
                                                                        ...
                                                                        {{ $medicine->prescriptions()->count() }} resep.
                                                                    </div>
                                                                @endif
                                                            </div>
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="text-muted small">
                                Menampilkan {{ $medicines->firstItem() ?? 0 }}-{{ $medicines->lastItem() ?? 0 }} dari
