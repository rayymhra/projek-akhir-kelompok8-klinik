...
@section('styles')
    <style>
        ...
        .timeline-marker.bg-info {
            background: linear-gradient(145deg, #0dcaf0, #31d2f2);
        }
...
@section('content')
            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-start">
                    <div class="d-flex align-items-center gap-3">
                        <a href="{{ route('transactions.index') }}" class="btn btn-outline-secondary btn-lg rounded-circle"
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="{{ route('transactions.index') }}"
                                            class="text-decoration-none">Transaksi</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">
                                        #TRX-{{ str_pad($transaction->id, 6, '0', STR_PAD_LEFT) }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <div class="d-flex align-items-center gap-3">
                        <div class="status-badge status-{{ $transaction->status }}">
                            <i
                                class="fas {{ $transaction->status === 'lunas' ? 'fa-check-circle' : ($transaction->status === 'menunggu' ? 'fa-clock' : 'fa-times-circle') }}"></i>
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="d-flex flex-wrap gap-3 mb-3">
                                    ...
                                    <span class="badge bg-secondary px-3 py-2">
                                        <i class="fas fa-calendar-alt me-2"></i> {{ $transaction->visit->patient->umur }}
                                        tahun
                                    </span>
                                    <span
                                        class="badge bg-{{ $transaction->visit->patient->jenis_kelamin == 'L' ? 'primary' : 'danger' }} px-3 py-2">
                                        <i
                                            class="fas fa-{{ $transaction->visit->patient->jenis_kelamin == 'L' ? 'mars' : 'venus' }} me-2"></i>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div>
                                                ...
                                                <span
                                                    class="fw-medium">{{ $transaction->visit->patient->alamat ?? '-' }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div>
                                                ...
                                                <span
                                                    class="fw-medium">{{ $transaction->visit->patient->no_hp ?? '-' }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div>
                                                ...
                                                <span
                                                    class="fw-medium">{{ $transaction->visit->tanggal_kunjungan->format('d/m/Y H:i') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
            ...
            <div class="col-lg-6">
                <div class="card h-100 border-0 shadow-lg">
                    <div class="card-header bg-gradient-success text-white py-3"
                        style="background: linear-gradient(145deg, #198754, #146c43);">
                        <h5 class="mb-0 fw-semibold">
                    ...
                    <div class="card-body p-4">
                        <div class="payment-method mb-4">
                            <i
                                class="fas {{ $transaction->metode_pembayaran == 'tunai' ? 'fa-money-bill-wave' : ($transaction->metode_pembayaran == 'transfer' ? 'fa-university' : ($transaction->metode_pembayaran == 'qris' ? 'fa-qrcode' : 'fa-wallet')) }}"></i>
                            <div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div>
                                        ...
                                        <span
                                            class="fs-5 fw-bold">{{ $transaction->created_at->format('d/m/Y H:i') }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div>
                                        ...
                                        <span
                                            class="fs-6 fw-bold text-primary">#TRX-{{ str_pad($transaction->id, 6, '0', STR_PAD_LEFT) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="alert alert-warning mt-3 mb-0">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 small">Silakan unggah bukti pembayaran untuk mengkonfirmasi transaksi
                                            ini.</p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-12">
                <div class="card border-0 shadow-lg">
                    <div class="card-header bg-gradient-warning text-white py-3"
                        style="background: linear-gradient(145deg, #ffc107, #ffca2c);">
                        <h5 class="mb-0 fw-semibold">
                                ...
                                <tfoot class="bg-light">
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-end">
                                            <h5 class="mb-0 fw-bold">TOTAL BIAYA:</h5>
                                        </td>
                                        <td class="text-end">
                ...
                <div class="col-12">
                    <div class="card border-0 shadow-lg">
                        <div class="card-header bg-gradient-info text-white py-3"
                            style="background: linear-gradient(145deg, #0dcaf0, #31d2f2);">
                            <h5 class="mb-0 fw-semibold">
                                ...
                                <div class="col-md-8">
                                    <div class="d-flex align-items-center gap-4">
                                        @if(Str::endsWith($transaction->bukti_pembayaran, ['.jpg', '.jpeg', '.png', '.gif']))
                                            <img src="{{ Storage::url($transaction->bukti_pembayaran) }}" alt="Bukti Pembayaran"
                ...
                <div class="card border-0 shadow-lg">
                    ...
                    <div class="card-body p-4">
                        <div class="d-grid gap-3">
                            ...
                            @if($transaction->status !== 'batal')
                                <button type="button" class="btn btn-danger-modern btn-modern" data-bs-toggle="modal"
                            ...
                            <button type="button" class="btn btn-outline-modern btn-modern" data-bs-toggle="modal"
                                        ...
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div>
                                                ...
                                                <p class="mb-0">
                                                    ...
                                                    <span
                                                        class="badge bg-info ms-2">{{ strtoupper($transaction->metode_pembayaran) }}</span>
                                                </p>
                                            </div>
                                            <small class="text-muted">
                                                <i class="fas fa-clock me-1"></i>
    ...
    <div class="modal fade custom-modal" id="confirmPaymentModal" tabindex="-1" aria-labelledby="confirmPaymentModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content modal-content-modern">
                ...
                <form action="{{ route('transactions.confirm', $transaction) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="modal-body-modern">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="upload-area" id="uploadArea">
                                ...
                                <input type="file" class="d-none" name="bukti_pembayaran" id="buktiPembayaran"
                                    accept="image/*,.pdf">
                            </div>
                        ...
                        <div class="alert alert-info">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 small">
                                        Total: <strong>Rp
                                            {{ number_format($transaction->total_biaya, 0, ',', '.') }}</strong><br>
...
document.addEventListener('DOMContentLoaded', function () {
    const metode = "{{ $transaction->metode_pembayaran }}";
    ...
    if (metode.toLowerCase() === 'tunai') {
        ...
        modalText.innerText = "Transaksi tunai tidak memerlukan bukti pembayaran.";
    } else {
    ...
    <div class="modal fade custom-modal" id="cancelTransactionModal" tabindex="-1"
        aria-labelledby="cancelTransactionModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content modal-content-modern">
    ...
    <div class="modal fade custom-modal" id="deleteTransactionModal" tabindex="-1"
                ...
                <form action="{{ route('transactions.destroy', $transaction) }}" method="POST" id="deleteTransactionForm">
                    ...
                    <div class="modal-body-modern">
                        <div class="text-center mb-4">
                            ...
                            <p class="modal-text">
                                Anda akan menghapus transaksi #TRX-{{ str_pad($transaction->id, 6, '0', STR_PAD_LEFT) }}
                                secara permanen.
                            </p>
                        </div>
